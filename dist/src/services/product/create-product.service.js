...
class CreateProductService {
    static validate(userId, name, suggestedRetailerPrice, unit, origin) {
    ...
    static create(userId, name, suggestedRetailerPrice, origin, unit, cost) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.validate(userId, name, suggestedRetailerPrice, unit, origin);
            const sid = yield this.getSid();
            const product = new refs_1.Product({ sid, name, suggestedRetailerPrice, origin, createBy: userId, cost, unit });
