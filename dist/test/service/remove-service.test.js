...
describe('DELETE /service/:serviceId', () => {
    ...
    it('Can remove service', () => __awaiter(this, void 0, void 0, function* () {
        ...
        // Check database
        const serviceDb = yield refs_1.Service.findById(serviceId);
        assert_1.equal(serviceDb, undefined);
    }));
    it('Cannot remove a removed service', () => __awaiter(this, void 0, void 0, function* () {
