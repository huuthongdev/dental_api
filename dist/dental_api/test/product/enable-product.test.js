...
describe('PUT /product/enable/:productId', () => {
    ...
    beforeEach('Prepare data for test', () => __awaiter(this, void 0, void 0, function* () {
        ...
        // Disable product
        yield refs_1.Product.findByIdAndUpdate(productId, { isActive: false });
    }));
    it('Can enable product', () => __awaiter(this, void 0, void 0, function* () {
    ...
    it('Cannot enable removed service', () => __awaiter(this, void 0, void 0, function* () {
